        ...
        <Navbar />
            ...
            <div className="px-12 py-10">
                ...
                {/* Right */}
                    ...
                    <div >
                        <p className="font-semibold text-2xl">Who We are</p>
                        <p className="text-sm py-4">
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eaque itaque <br />
                        amet magnam et accusamus fugiat aliquid adipisci beatae excepturi sit.<br />
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eaque itaque <br />
                        amet magnam et accusamus fugiat aliquid adipisci beatae excepturi sit.<br />
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eaque itaque <br />
                        minima sapiente natus, earum inventore quis, necessitatibus hic aut, id <br />
                        amet magnam et accusamus fugiat aliquid adipisci beatae excepturi sit.<br />
                        </p>
                    </div>
            ...
            <div className='flex flex-col justify-center items-center mb-32'>
                    <div>
                        <div>
                            <p className='font-semibold text-2xl mb-3 mt-10 px-10'>Meet our leaders</p>
                            <p className="text-sm mb-10">Lor At et officia beatae ipsa, quidem <br />
                                dicta voluptates, volu dolorum error?</p>

                        </div>
                    </div>
                    <div className="flex gap-10">
                        <div className="grid gap-4 items-center">
                        <img className='w-56 h-56 border-slate-300 border-4 rounded-full' src={Man} alt="" />
                            <div className='text-center w-72 h-20 rounded-lg bg-blue-300 shadow-xl'>
                        ...
                        <div className="grid gap-4 items-center">
                        <img className='w-56 h-56 border-slate-300 border-4 rounded-full' src={Man} alt="" />
                            <div className='text-center w-72 px-4 py-6 rounded-lg bg-blue-300 shadow-xl'>
